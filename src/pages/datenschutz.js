...
export default function Impressum() {
    return (
        <Layout>
            <main className="bg-indigo-800 text-white rounded-xl mt-4 p-6 break-words ">
                ...
                <Typography variant="h4">Wer ist verantwortlich für die Datenerfassung auf dieser Website?</Typography>
                <Typography>Die Datenverarbeitung auf dieser Website erfolgt durch den Websitebetreiber. Dessen Kontaktdaten können Sie dem Abschnitt „Hinweis zur Verantwortlichen Stelle“ in dieser Datenschutzerklärung entnehmen.</Typography>

                <Typography variant="h4">Wie erfassen wir Ihre Daten?</Typography>
                <Typography>Ihre Daten werden zum einen dadurch erhoben, dass Sie uns diese mitteilen. Hierbei kann es sich z. B. um Daten handeln, die Sie in ein Kontaktformular eingeben.
                </Typography>
                <br></br>
                <Typography>Andere Daten werden automatisch oder nach Ihrer Einwilligung beim Besuch der Website durch unsere IT- Systeme erfasst. Das sind vor allem technische Daten (z. B. Internetbrowser, Betriebssystem oder Uhrzeit des Seitenaufrufs). Die Erfassung dieser Daten erfolgt automatisch, sobald Sie diese Website betreten.
                </Typography>
                <Typography variant="h4">Wofür nutzen wir Ihre Daten?</Typography>
                <Typography>Ein Teil der Daten wird erhoben, um eine fehlerfreie Bereitstellung der Website zu gewährleisten. Andere Daten können zur Analyse Ihres Nutzerverhaltens verwendet werden.
                </Typography>

                <Typography variant="h4">Welche Rechte haben Sie bezüglich Ihrer Daten?</Typography>
                <Typography>Sie haben jederzeit das Recht, unentgeltlich Auskunft über Herkunft, Empfänger und Zweck Ihrer gespeicherten personenbezogenen Daten zu erhalten. Sie haben außerdem ein Recht, die Berichtigung oder Löschung dieser Daten zu verlangen. Wenn Sie eine Einwilligung zur Datenverarbeitung erteilt haben, können Sie diese Einwilligung jederzeit für die Zukunft widerrufen. Außerdem haben Sie das Recht, unter bestimmten Umständen die Einschränkung der Verarbeitung Ihrer personenbezogenen Daten zu verlangen. Des Weiteren steht Ihnen ein Beschwerderecht bei der zuständigen Aufsichtsbehörde zu.
                    Hierzu sowie zu weiteren Fragen zum Thema Datenschutz können Sie sich jederzeit an uns wenden.
                </Typography>

                <Typography variant="h4">Analyse-Tools und Tools von Drittanbietern</Typography>
                <Typography>Beim Besuch dieser Website kann Ihr Surf-Verhalten statistisch ausgewertet werden. Das geschieht vor allem mit sogenannten Analyseprogrammen.
                </Typography>
                <Typography>Detaillierte Informationen zu diesen Analyseprogrammen finden Sie in der folgenden Datenschutzerklärung.
                </Typography>
                ...
                <Typography variant="h2">1. Datenschutz auf einen Blick Allgemeine Hinweise</Typography>
                ...
                https://aws.amazon.com/de/blogs/security/aws-gdpr-data-processing-addendum/. Weitere Informationen entnehmen Sie der Datenschutzerklärung von AWS:
                ...
                Beispielfirma Musterweg 10 90210 Musterstadt
                Telefon: +49(0) 123 44 55 66 E - Mail: info @beispielfirma.de
