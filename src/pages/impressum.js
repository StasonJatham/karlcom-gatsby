...
export default function Impressum() {
    return (
        <Layout>
            <Typography variant="h1" className="my-6 sm:text-center pl-6 sm:pl-0">Impressum</Typography>

            <div className="grid gap-0 sm:gap-2 md:gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
