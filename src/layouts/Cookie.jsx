            ...
            {!cookieAccepted && (
                <section className="fixed max-w-2xl p-4 mx-auto bg-white border border-gray-200 md:gap-x-4 left-12 bottom-16 dark:bg-gray-900 md:flex md:items-center dark:border-gray-700 rounded-2xl">
                    <div className="flex items-center gap-x-4">
                        <span className="inline-flex p-2 text-indigo-800 rounded-lg shrink-0 dark:bg-gray-800 bg-indigo-100/80">
                            <FontAwesomeIcon icon={faCookieBite} />
                        </span>

                        <p className="text-sm text-gray-600 dark:text-gray-300">We use cookies to ensure that we give you the best experience on our website. <a href="/impressum" className="text-blue-500 hover:underline">Read cookies policies</a>. </p>
                    </div>
                    ...
                    <div className="flex items-center mt-6 gap-x-4 shrink-0 lg:mt-0">
                        ...
                        <Button onClick={cookieAcceptHandler} className="w-32  border  text-xs  md:w-auto font-medium rounded-lg  px-4 py-2.5 duration-300 transition-colors focus:outline-none">Accept</Button>
                    </div>
                </section >
            )}
        </>
